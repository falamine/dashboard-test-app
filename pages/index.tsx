...
const Home: NextPage = () => {
    ...
    return (
            <div className="flex flex-col gap-2 xl:p-10 xxl:p-20 sm:p-0 md:p-3">
                ...
                {error ? <div className="flex flex-col">
                        ...
                        <span><button className="" onClick={router.reload}><i className="bi bi-arrow-left"></i> Back</button></span>
                    </div>
                    : !dataFetched ? <div className="font-bold">Loading...</div>
                        : <>
                            <div className="">{transactions?.data?.map(tr => <div
                                    className='w-100 bg-gray-100 border-bottom border-black my-1' key={tr.id}>
                                    <div className="flex p-2">
                                        <div className="grow">
                                            ...
                                            <div>
                                                <code className="p-1 rounded bg-gray-300">
                                                    {tr.id.substring(0, 8)}
                                                    &nbsp;
